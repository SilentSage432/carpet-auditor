...
## Latest (2026-09-05)
- **FY2026 authoritative fiscal calendar SEEDED:** Lowe's Vendor Gateway `Fiscal_calendar.pdf` page **2026** → `fiscal_years=1`, `fiscal_weeks=52` (`2026-01-31`→`2027-01-29`, Sat–Fri weeks). Provenance: `COMPANY_PUBLISHED` + URL. Holidays/events **not** imported. ISO `assigned_week` remains distinct. Artifact: `data/fiscal-calendars/lowes-fy2026-company-published.json`. Next: **FS-001A** lifecycle/coverage (not started). FS-002 not started.
