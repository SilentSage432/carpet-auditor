...
## Latest (2026-09-07)
- **UX-005 GOVERNING BACKLOG PRESERVED:** Full program constraints live in [`docs/product/UX005_OPERATIONAL_SIMPLICITY_BACKLOG.md`](docs/product/UX005_OPERATIONAL_SIMPLICITY_BACKLOG.md). UX-005A is the **first tranche only** — not the whole program. Open Question Its Place items (except dual Start owned by 005A; action bar demoted not deleted), UX/product/architecture debt, do-not-touch guardrails, and sequence **UX-005B→F** remain active. Do not silently resolve later questions inside 005A.
