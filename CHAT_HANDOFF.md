...
## Latest (2026-09-07)
- **APP-CAT-001A MULTI-IDENTIFIER RESOLUTION — IMPLEMENTED — AWAITING COMMIT / MIGRATION APPLY / FIELD VALIDATION:** Many taught identifiers → one `(store_number, item_number)`; legacy `upc` retained; Link vs Create teach; no type enum; CAT-001B local promotion deferred; APP-ROT-001 after field acceptance.
