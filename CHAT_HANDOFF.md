...
## Latest (2026-09-06)
- **APP-AUD-001 / APP-AUD-001A COMMITTED — PRODUCTION MIGRATION PENDING:** Physical audit sessions + Option B reconciliation state; observation-time CLOSED bind; close flush/block; clear preserves audit-bound scans. Apply `supabase/migrations/20260906_appliance_audit_sessions.sql` before production use. No Lowe's/SIMS/Zebra integration; not immutable OH history.
