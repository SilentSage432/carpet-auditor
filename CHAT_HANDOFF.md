...
- QR redemption: `/pair?t=` previews without burning; PIN + confirm burns `invite_token_hash`, hashes a 4–6 digit PIN, and mints Hub-bridge Auth with `store_number` in JWT `app_metadata`
