...
const ROTATION_SELECT_WORKFLOW =
  "id, department_id, location_id, assigned_week, is_completed, completed_at, created_at, verification_status, completed_by, verified_by, verified_at, review_note, store_locations(id, aisle, bay, type, last_completed_at, last_serviced_at, status, cycle_number, workflow_type)";
