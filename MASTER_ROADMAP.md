...
- [ ] LAB-001 Department Labor Availability — **NEXT FOUNDATION**: independent operational-fact composer over roster / schedule / call-out. Labor Availability ≠ Capacity ≠ Productivity ≠ Recommendation ≠ Weekly Target. No bay conversion; no ranking; no rotation mutation; UI deferred to whole-product audit.
- [ ] Seasonal / recommendation intelligence follow-ons — only after product need; no premature priority score/rank; no inferred capacity
