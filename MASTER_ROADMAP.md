...
## Done
- [x] APP-AUD-002B Physical evidence freeze hardening — Option B: explicit membership; CLOSED WHAT/WHERE/WHEN/WHICH freeze (API + DB); ad-hoc/Floor unbound (**IMPLEMENTED — MIGRATION PENDING APPLY — REAL-HARDWARE VALIDATION PENDING**)
...
## Next
- [ ] **Appliances — APP-AUD-002B** apply `20260907_appliance_scans_closed_evidence_freeze.sql` + field validation; then close APP-AUD-002
