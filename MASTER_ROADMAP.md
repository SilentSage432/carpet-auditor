...
## Done
- [x] APP-UX-001 Appliance Teach & Catalog Recovery — Manage mappings sheet + quiet known-UPC scan + Quick-Add teach + UPC conflict guard (**IMPLEMENTED LOCALLY — AWAITING COMMIT REVIEW**; no reconciliation/OH/session)
