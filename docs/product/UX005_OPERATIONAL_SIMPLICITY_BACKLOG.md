...
| 5 | Velocity Heatmap | Used instead of or alongside Standard Map? | **Not owned** — remains open (UX-005D). **PRIORITY-UX-001** (2026-09-18) supplies repository evidence that Advanced · Service cadence / `velocity_tier` is **not** durable rotation priority (`priority_override`); it does **not** close UX-005D |
