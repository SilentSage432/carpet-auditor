...
| Temporal week copy | Floor `Staging week` / Map `Calendar week` presentation helpers | **IMPLEMENTED LOCALLY — AWAITING COMMIT REVIEW** — clocks unchanged; Sunday staging vs calendar divergence intentional; fiscal separate; Map overlay week prop deferred |
